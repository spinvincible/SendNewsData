...
class FirebaseUtil {
    public static DatabaseReference getBaseRef() {
        return FirebaseDatabase.getInstance().getReference().child("AllSitesCompilations");
    }
...
//    }
    ...
    public static DatabaseReference getAllPostsRef() {
        return getBaseRef().child("All_Posts");
    }
    public static DatabaseReference getNYTRef() {
        return getBaseRef().child("NewYorkTimes");
    }
    public static String getAllPostsPaths() {
        return "All_Posts/";
    }
    public static String getNYTPaths() {
        return "NewYorkTimes/";
    }
